  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        ...
        { name, email, password, phone, address, securityAns }
      );
    ...
    <Layout>
      <div className="register bg-gradient-to-t from-gray-600 via-gray-700 to-gray-800 p-16 pb-8">
        <form
          ...
          className="bg-white max-w-md shadow-black shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-auto bg-gradient-to-t from-gray-600 via-gray-700 to-gray-700 text-gray-300"
        >
          <div className="mb-4">
            <label htmlFor="name" className="block  text-sm font-bold mb-2">
              Name
